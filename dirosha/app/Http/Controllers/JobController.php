...
class JobController extends Controller
{
    ...
    public function AddJob($category)
    {
        ...
        return view('admin.website.job_create', compact('category', 'next_position', 'categories'));
    }
    ...
    public function store(Request $request, $nav_category)
    {
        ...
        $fee_particular = $request['fee_particular'];
        $admission = $request['admission'];
        $security_deposit = $request['security_deposit'];
        $exam_charge = $request['exam_charge'];
        $maintenance = $request['maintenance'];
        $tuition_fee = $request['tuition_fee'];
        // $tuition_fee = $request['objectives'];
        // $tuition_fee = $request['criteria'];
        ...
        unset($request['courses_title']);
        unset($request['semister']);
        unset($request['course_number']);
        unset($request['internal_number']);



        unset($request['theory_number']);
        unset($request['practical_final']);
        unset($request['fee_particular']);
        unset($request['admission']);


        unset($request['security_deposit']);
        unset($request['exam_charge']);
        unset($request['maintenance']);
        unset($request['tuition_fee']);
        // unset($request['objectives']);
        // unset($request['criteria']);
        ...
        if ($navigation) {
            ...
            $job->semister = $semister;
            $job->course_number = $course_number;
            $job->courses_title = $courses_title;
            $job->internal_number = $internal_number;
            $job->theory_number = $theory_number;
            $job->practical_final = $practical_final;
            $job->fee_particular = $fee_particular;
            $job->admission = $admission;
            $job->security_deposit = $security_deposit;
            $job->exam_charge = $exam_charge;
            $job->maintenance = $maintenance;
            $job->tuition_fee = $tuition_fee;

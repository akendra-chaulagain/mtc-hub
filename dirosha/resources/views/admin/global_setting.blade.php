        ...
        <div class="box box-info">
            ...
            <form action="{{ route('update.global_setting') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="other" name="other" class="form-control" placeholder="Address"
                        value="{{ $global_setting->other }}">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    <label for="address_ne">Corporate Address</label>
                ...
                <div class="form-group col-md-6">
                    <img src="{{ asset('/dirosha/public/uploads/icons/' . $global_setting->favicon) }}" width="150px"
                ...
                <div class="form-group col-md-6">
                    <img src="{{ asset('/dirosha/public/uploads/icons/' . $global_setting->site_logo) }}" width="150px"
                        class="img-responsive img-thumbnail">
                </div>
                <div class="clearfix"></div>
                ...
                <div class="form-group col-md-6">
                    <img src="{{ asset('/dirosha/public/uploads/icons/' . $global_setting->site_logo_nepali) }}"
                        width="150px" class="img-responsive img-thumbnail">
                </div>

                    ...
                    @foreach ($photos as $photo)
                        <div class="col-lg-3 col-md-4">
                            <a href="{{ route('galleryview', $photo->nav_name) }}">
                                <div class="folder">
                                    <div class="paper folder-pop"><img src="/dirosha/{{ $photo->banner_image }}" width="100%">
                                    </div>
                                    <div class="paper folder-pop-middle"><img src="/dirosha/{{ $photo->banner_image }}"
                                            width="100%">
                                    </div>
                                    <div class="paper folder-pop-last"><img src="/dirosha/{{ $photo->banner_image }}" width="100%">
                                    </div>
                                </div>
